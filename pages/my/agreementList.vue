	...
	<view class="agreementList page">
		...
		<view style="margin: 0 30rpx">
			<u-cell-group>
				...
				<u-cell-item style="border-bottom: 1px solid #e6e6e6" @click="clickbtn('/pages/agreement?type=2')" paddings="26rpx 0"
				 :title="titleList3" :arrow="true" arrow-direction="right" :border-top="true">
				</u-cell-item>
			<!-- 	<u-cell-item style="border-bottom: 1px solid #e6e6e6" @click="clickbtn('/pages/agreement?type=3')" paddings="26rpx 0"
				 :title="titleList4" :arrow="true" arrow-direction="right" v-if="project!='law'">
				</u-cell-item> -->
			</u-cell-group>
			<view v-if="isUpdata" @click="isUpdata=false" style="height: 100vh;width: 100%; position: fixed;top: 0upx;left: 0;display: flex;align-items: center;justify-content: center;z-index: 77777777;">
				...
				<view class="upbg" @click.stop style="z-index: 99999999999999999;">
					...
					<view class="" v-if="IsReadyUpdate" style="position: relative;">
						...
						<view class="" style="position: absolute;top: 282upx;left: 0;">
							<view class="" style="color: #FE4351;font-size: 36upx;font-weight:800;width: 570upx;text-align: center;">
								{{this.$t('ibinz.msg150',['发现新版本'])}} {{updateInfo.versionName}}
							</view>
					...
					<view v-else style="width: 570upx;height: 482upx;background: #FFFFFF;display: flex;justify-content: center;align-items: center;flex-direction: column;border-radius: 15upx;">
						...
						<view style="width: 476upx;height: 75upx;line-height: 75upx;text-align: center;color: #666666;font-size: 30upx;margin-bottom: 40upx;"
	...
	export default {
		data() {
			return {
				...
				list:[
					{
						title:this.$t('ibinz.msg149',['官方网站']),
						url:'https://www.dolaimi.org'
					},
					// {
					// 	title:'Twitter',
				...
				navTitle:this.$t('ibinz.msg144',['关于']),
				titleList1:this.$t('ibinz.msg145',['检查更新']),
				titleList2:this.$t('ibinz.msg146',['用户协议']),
				titleList3:this.$t('ibinz.msg147',['隐私政策']),
				titleList4:this.$t('ibinz.msg148',['关于我们']),
			};
		},
		onLoad(opt) {
			var _this = this;
			...
			// #endif
			// #ifdef H5
			this.versionCode = _this.versionCode || "0.0.0"
			// #endif
		},
		methods: {
			clickbtn(e) {
