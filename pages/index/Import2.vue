	...
	<base-layout>
		<view>
			...
			<view class="importbox">
				...
				<button v-else class="nosubmit">{{$t('home.txt13',['导入钱包'])}}</button>
			</view>
		</view>
	</base-layout>
</template>
	...
	export default {
		data() {
			return {
				...
				navTitle: this.$t('home.txt101', ['助记词导入']),
				placeholder: this.$t('home.txt132', ['助记词，用空格分隔，请注意大小写']),
				...
				btnTitle: this.$t('home.txt13', ['导入钱包'])
			}
		},
		onLoad(o) {
			console.log("助记词导入", o);
